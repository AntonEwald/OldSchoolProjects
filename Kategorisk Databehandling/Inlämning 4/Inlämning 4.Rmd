...
rad2 <- t(c("(XYZV)", 0.0000000, round(model41a$df.residual,5), pa))
...
$$
log(\mu_{ijkl})=\lambda+\lambda_i^X+\lambda_j^Y+\lambda_k^Z + \lambda_l^V+\lambda_{ij}^{XY}+\lambda_{il}^{XV}+\lambda_{kl}^{YV}
$$
...
$$
\hat{\theta}_{ZV} = \exp(\hat{\lambda}_{11}^{YZ})=exp(3.32798) = 27.88196
$$

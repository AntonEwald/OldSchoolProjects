...
If we would like to calculate the estimated odds, $O_i$ for each dose we simply calculate $\frac{p_{i}}{1-p_i}$ för each dose $x_i, i \in \{1,2,3,4,5,6\}$. The result of this method yield, $$O_1 = \frac{\frac{1}{18}}{1-\frac{1}{18}},O_2 = \frac{\frac{2}{19}}{1-\frac{2}{19}},O_3 = \frac{\frac{4}{28}}{1-\frac{4}{28}},O_4 = \frac{\frac{9}{32}}{1-\frac{9}{32}},O_5 = \frac{\frac{12}{28}}{1-\frac{12}{28}},O_6 = \frac{\frac{32}{40}}{1-\frac{32}{40}}.$$
